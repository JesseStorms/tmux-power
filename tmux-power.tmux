...
tmux_set @prefix_highlight_output_prefix "#[fg=$G04]#[bg=$TC]$right_arrow_icon#[bg=$TC]#[fg=$BG]"
...
tmux_set status-left-length 300
user=$(whoami)
LS="#[fg=$G04,bg=$TC,bold] $user_icon termi #[fg=$TC,bg=$G06,nobold]$right_arrow_icon#[fg=$TC,bg=$G06] $session_icon #S "

LS="$LS#[fg=$G06,bg=$G05]$right_arrow_icon#[fg=$TC,bg=$G05]#[bg=$G05]#[fg=$TC]C:\#{df_percent}#[fg=$G05]#[bg=$BG]$right_arrow_icon"
...
tmux_set status-right-length 300
...
RS="#[fg=$G05,bg=$G04]$left_arrow_icon#[fg=$TC,bg=$G05] #{cpu_fg_color}#{cpu_icon}#{cpu_percentage} #{ram_fg_color}#{ram_icon}#{ram_percentage}#[fg=$G04,bg=$G05]$RS"
tmux_set status-right "$RS"

# Window status
tmux_set window-status-format "#I:#W#F"
tmux_set window-status-current-format "#[fg=$BG,bg=$TC]$right_arrow_icon#[fg=$G06,bold] #I:#W#F #[fg=$TC,bg=$BG,nobold]$right_arrow_icon"
